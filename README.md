...
[![Go Report Card](https://goreportcard.com/badge/github.com/shouni/gcp-kit)](https://goreportcard.com/report/github.com/shouni/gcp-kit)
...
* **`auth`**: **Google OAuth2 認証 & セッション管理**
  ...
  * **M2M(サーバー間通信)検証**: `M2MVerifier` により、他サービスから発行された OIDC Bearer トークンをサービスアカウント許可リストと照合し、セッション不要の安全なサーバー間API呼び出しを実現。
